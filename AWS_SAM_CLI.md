...
This is a sample template for auto_snapshot - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name auto_snapshot --query 'Stacks[].Outputs'
```
